...
function about() {
    return (
        ...
        <div className="aboutInner">
            <div className="headerTextDark">About us</div>
            <div className="textDark">
                Named “Best Salon” by Main Line Magazine & The Philadelphia Inquirer, Prauge Salon & Style Bar has been committed to “raising the bar ” since opening our doors in 2014. Our mission is simple, give every guest an excellent experience by providing them with a warm, inviting culture & results that surpass expectations.
            ...
            <br/>
            <div className="bottomText">Schedule your reservation today!</div>
        </div>
        </div>
    )
}
